...
- 华山绿地按公开场地边界和 21 条园路建模，包含成熟乔木与林下灌木、水景栈桥、篮球场、围网、球架、鸟笼架、幸福角、长椅和照明
- 上生·新所按公开场地与 11 个建筑轮廓建模，重点还原乡村俱乐部、孙科别墅、海军俱乐部露天泳池，以及新旧建筑、树阵、喷泉和入口雨棚
...
- 三处地标的建筑高度、立面细节、植被和未标注环境要素均依据公开照片与文字做风格化原创表现；除三处地标外的全街道建筑尚未填充。
