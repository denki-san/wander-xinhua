...
const output = {
  ...
  currentRuntimeDiagnostic: {
    status: "pass-load-performance-collision-stop-qa-only",
    record: "docs/research/shanghai-orchestra-threejs-runtime-qa.json",
  ...
  blocker: {
    ...
    mcp1Record: "docs/research/shanghai-orchestra-blender-mcp-gates.json",
    nextGate: "Obtain formal member-set evidence before map promotion or Identity; QA-only runtime diagnosis may continue.",
  },
};
