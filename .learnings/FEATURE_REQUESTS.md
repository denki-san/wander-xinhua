...
## [FEAT-20260725-002] 建筑资产工作流程与详情管理
...
为独立资产后台增加建筑制作流程页面，并在现有资产总览中扩充建筑详情。

### User Context
工作流程页集中展示参考证据、模型 Brief、灰模校准、Hero、质量等级、构建审计、运行时验收与独立审查；资产总览的建筑详情集中展示三档质量状态、相关文档、照片对照和对应 POI 游戏入口。

### Metadata
- Frequency: first_time
- Related Features: asset-library, workflow, building-detail, poi-entry

### Resolution
- **Resolved**: 2026-07-25
- **Notes**: 已拆分独立工作流程页，并在资产总览中接入建筑详情。
