...
export const TREE_ASSETS = [
  {
    ...
    subtitle: "335 个线上实例",
    status: "online",
    model: "/models/xinhua-road/plane-tree-a.glb?v=4c0f78206959",
    variants: ["A · 直干开冠", "B · 左倾开冠", "C · 右倾开冠", "D · 分叉团冠"],
    instanceCount: 335,
    note: "7 条道路 332 株 + 幸福里 3 株；近景按空间索引使用四款 Identity，中远景与弱网使用三款 Massing",
  },
  {
    id: "campus-tree",
    category: "trees",
...
export const CHARACTER_ASSETS = [
  {
    ...
    subtitle: "当前线上主角",
    status: "online",
    model: "/models/character/rain-summer-wanderer.glb?v=45d2d21d2315",
