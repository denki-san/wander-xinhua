...
const SUN_KE_VILLA: AssetRecord = {
  ...
  subtitle: "番禺路60号",
  status: "online",
  model: "/models/shangsheng/sun-ke-villa.glb?v=6d1642315530",
  qualityLevels: [
    {
      id: "hero",
      name: LEVEL_NAMES.hero,
    ...
    },
    {
      ...
      name: LEVEL_NAMES.identity,
      status: "ready",
      model: "/models/tiers/sun-ke-villa/identity/sun-ke-villa-identity.glb?v=6b541e8ffab4",
      note: "已接入中距离识别层",
    },
    {
      id: "massing",
      name: LEVEL_NAMES.massing,
      status: "internal",
      model: "/models/tiers/sun-ke-villa/massing/sun-ke-villa-massing.glb?v=f233f9defd21",
      note: "已接入全览体块层",
    },
  ],
  note: "上生·新所三档生产建筑",
...
export const DECOR_ASSETS = [
  ...
  {
    id: "xingfuli-pointed-entry-bollard",
    category: "decor",
    name: "幸福里入口尖顶路桩",
    subtitle: "番禺路381号入口",
    status: "online",
    model: "/models/nonbuilding/xingfuli-current-street-furniture/xingfuli-pointed-entry-bollard-visible-low.glb",
    variants: ["方柱身 · 四坡尖顶帽"],
    note: "按入口现场证据制作并接入当前场景",
  },
  {
    id: "xingfuli-water-edge-stone-seat-round",
    category: "decor",
    name: "幸福里临水圆形石座",
    subtitle: "幸福里内部水景段",
    status: "online",
    model: "/models/nonbuilding/xingfuli-current-street-furniture/xingfuli-water-edge-stone-seat-round-visible-low.glb",
    variants: ["近球形 · 底部收平"],
    note: "临水座具家族的圆形实例",
  },
  {
    id: "xingfuli-water-edge-stone-seat-long",
    category: "decor",
    name: "幸福里临水长形石座",
    subtitle: "幸福里内部水景段",
    status: "online",
    model: "/models/nonbuilding/xingfuli-current-street-furniture/xingfuli-water-edge-stone-seat-long-visible-low.glb",
    variants: ["长椭圆 · 圆钝端部"],
    note: "临水座具家族的长形实例",
  },
  {
    id: "xingfuli-water-edge-slim-planter",
    category: "decor",
    name: "幸福里临水窄型花槽",
    subtitle: "幸福里内部线性水景",
    status: "online",
    model: "/models/nonbuilding/xingfuli-current-street-furniture/xingfuli-water-edge-slim-planter-visible-low.glb",
    variants: ["窄矩形槽体 · 高低植物"],
    note: "包含槽体、土层与植物层",
  },
] satisfies AssetRecord[];
