...
| 13 | `fahua-heritage` | 法华遗韵 | 旧牌坊结构基线与 Recovery 合格子阶段只读保留；公开资料新增同主体宽街景，并确认它是东端牌坊、1木3石仿古桥及文化长廊组成的纪念性重建景观 | `blocked-evidence-map` / Hold | XHS 四组慢速查询、同主体多视角/街道边界验收与未命中停用合同已备但尚未执行；Chrome 当前未运行，禁止把未搜索写成 exhausted，全部文件与 Hold 永久保留 |
