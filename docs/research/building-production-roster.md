...
| 6 | `house-315` | 新华路315号住宅 | 官方 canonical、俯瞰纵深、入口/门牌证据已闭合；subject-specific Massing、主窗口 MCP 1 与实际 Three.js 地图门已通过并整合至 `059269e` / `770ecce`；旧 Hero/Recovery voxel/OSM 未复用 | `in-scope` / Massing complete | 保持 1930/1949 年代冲突为 Unknown；先只读审计旧 Hero 的主体绑定、拓扑、范围污染与 lineage，未通过 disposition 前不得制作 Identity 或接公共 runtime |
